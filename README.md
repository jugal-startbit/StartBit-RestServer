...
You can [view the RestServer class](https://github.com/jugal-startbit/RestServer/blob/master/RestServer.php), copy it and use it for your own purposes. It is under the MIT license. Features to be added include XML support and HTTP Authentication support. If you make this class better please share your updates with everyone by leaving a comment. I will try and keep this class updated with new features as they are shared. I hope you enjoy!
...
## By [Hand](https://github.com/jugal-startbit/RestServer)
...
## By [Packagist](https://packagist.org/packages/startbit/restserver)
